...
# DONT NEED- creates frames from videos and the calls process_frame function and down sample image resolution to 216*216, and make sequence length 10
def process_clip(src_dir, dst_dir, seq_len, img_size, mean=None, normalization=True,
    ...
    all_frames = []                                     #we dont need this section where frames are extracted from videos
...
#process the directory names for each file in dataset
...
# calls and times the preprocessing function above
